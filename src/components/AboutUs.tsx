    ...
    <div className="animate-fade-in" style={{ backgroundColor: 'var(--silk-100)', paddingBottom: '60px' }}>
      ...
      <section className="section-padding" style={{ 
        ...
        <div className="container">
          ...
          <h1 style={{ fontFamily: 'var(--font-serif)', color: 'white', fontSize: '3rem', marginBottom: '20px' }}>
            Over 4 Decades of Healing & Aesthetic Science
          </h1>
      ...
      <section className="section-padding" style={{ backgroundColor: 'white' }}>
        <div className="container treatment-layout">
          ...
          <div style={{ position: 'relative', borderRadius: '12px', overflow: 'hidden', height: '380px', boxShadow: 'var(--shadow-lg)' }}>
            <img 
      ...
      <section className="section-padding" style={{ backgroundColor: 'var(--silk-100)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
            <div className="glass" style={{ padding: '30px', borderRadius: '10px', background: 'white', border: '1px solid var(--silk-200)', textAlign: 'left' }}>
      ...
      <section className="section-padding" style={{ backgroundColor: 'white' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px' }}>
            {/* Doctor 1 */}
            <div className="glass" style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--silk-200)', display: 'flex', flexDirection: 'column', textAlign: 'left', background: 'white' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--gold-600)', fontWeight: '600', display: 'block', margin: '4px 0 10px' }}>MD, DVD, DHA (48+ Years Exp)</span>
            ...
            <div className="glass" style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--silk-200)', display: 'flex', flexDirection: 'column', textAlign: 'left', background: 'white' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--gold-600)', fontWeight: '600', display: 'block', margin: '4px 0 10px' }}>MD (Derm), FAM (12+ Years Exp)</span>
                <p style={{ fontSize: '0.85rem', color: 'var(--muted-charcoal)', lineHeight: '1.5' }}>
            ...
            <div className="glass" style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--silk-200)', display: 'flex', flexDirection: 'column', textAlign: 'left', background: 'white' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--gold-600)', fontWeight: '600', display: 'block', margin: '4px 0 10px' }}>MS, MCh (Plastic Surgery) (9+ Years Exp)</span>
                <p style={{ fontSize: '0.85rem', color: 'var(--muted-charcoal)', lineHeight: '1.5' }}>
