    ...
    <>
      ...
      <main key={currentPage} className="page-transition-enter" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowX: 'hidden' }}>
        ...
        <div className="container hero-container">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  <h6 style={{ color: 'white', fontSize: '0.95rem', fontWeight: 'bold' }}>
                    <AnimatedCounter target={45} suffix="+" /> Years Legacy
                  </h6>
          ...
          <div className="glass desktop-only reveal reveal-right" style={{ padding: '30px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.15)', color: 'var(--charcoal)' }}>
        ...
        <div className="container footer-main">
          <div>
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
              <a 
                href="https://www.instagram.com/ycdc_india?igsh=MXFmYnBwdnFqdDltaA==" 
                target="_blank" 
                rel="noopener noreferrer" 
                style={{
                  width: '36px',
