          ...
          <div className="glass" style={{ padding: '40px', borderRadius: '12px', background: 'white', border: '1px solid var(--silk-200)', textAlign: 'left', boxShadow: 'var(--shadow-sm)' }}>
            ...
            {isSuccess ? (
              <div className="animate-fade-in" style={{ textAlign: 'center', padding: '30px 0' }}>
                ...
                <button onClick={() => setIsSuccess(false)} className="btn btn-outline" style={{ padding: '8px 16px', fontSize: '0.85rem', cursor: 'pointer' }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <button type="submit" disabled={submitting} className="btn btn-accent" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '12px', cursor: 'pointer' }}>
